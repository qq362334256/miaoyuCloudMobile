...
const { maxFileSize, proConfig: {RESOURCES_URL: publicPath, vendor} } = require('./../config.json');
const { context, entry, crossOriginLoading, resolve, plugins, devtool, output: {path}, module: {rules} } = require('./webpack.basic.js');
